...
class Trainer:
    ...
    def __init__(self,
        ...
        self.epochs = epochs
        #self.adap_momentum = adap_momentum
        ...
        # Define our optimizer. SGD = Stochastich Gradient Descent for task 3
        self.optimizer = torch.optim.SGD(self.model.parameters(),
                                         self.learning_rate)#, momentum = adap_momentum)
